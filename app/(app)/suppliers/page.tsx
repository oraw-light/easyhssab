...
export default async function SuppliersPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <form action={addSupplier} className="bg-white p-6 rounded-3xl border-2 border-[#1A1A1A] shadow-[4px_4px_0px_0px_rgba(26,26,26,1)] grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-4 items-end">
